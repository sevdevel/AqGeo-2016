...
#=============================================================================
# Steady simulation kFIO=Millero(start from 00 CSFe Transient 4)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.FIO=1E+14"
...
#=============================================================================
# Steady simulation kCSO=Millero(start from 00 CSFe Transient 4)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.CSO=1E+5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Transient k.ISP=3E+8"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation kISP=Rickard(start from 00 CSFe Transient 4)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.ISP=1E+6"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("20 CSFe Steady k.ISP=1E+6 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.ISP=1E+8"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("20 CSFe Steady k.ISP=1E+8 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.ISP=1E+10"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("20 CSFe Steady k.ISP=1E+10 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.ISP=1E+12"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("20 CSFe Steady k.ISP=1E+12 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "20 CSFe Steady k.ISP=3E+14"
sim.info$name <- paste(sim.info$code,sim.info$index)
