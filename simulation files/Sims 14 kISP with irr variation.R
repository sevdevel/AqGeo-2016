...
sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+03 + irr"
...
load("14 CSFe Steady k.ISP=1E+03 + irr 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Transient k.ISP=1E+02 + irr"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Transient k.ISP=1E+02 + irr 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+02 + irr"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Steady k.ISP=1E+02 + irr 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Transient k.ISP=1E+01 + irr"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Transient k.ISP=1E+01 + irr 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+01 + irr"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Steady k.ISP=1E+01 + irr 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Transient k.ISP=1E+00 + irr"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Transient k.ISP=1E+00 + irr 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+00 + irr"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Steady k.ISP=1E+00 + irr 1.Rdata")
