...
sim.info$index <- 1
sim.info$code <- "12 CSFe Steady k.ISP=1E+03"
...
load("12 CSFe Steady k.ISP=1E+03 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "12 CSFe Dynamic k.ISP=1E+02"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("12 CSFe Transient k.ISP=1E+02 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "12 CSFe Steady k.ISP=1E+02"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("12 CSFe Steady k.ISP=1E+02 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "12 CSFe Transient k.ISP=1E+01"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("12 CSFe Transient k.ISP=1E+01 1.Rdata")
...
load("12 CSFe Steady k.ISP=1E+01 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "12 CSFe Transient k.ISP=1E+00"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("12 CSFe Transient k.ISP=1E+00 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "12 CSFe Steady k.ISP=1E+00"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("12 CSFe Steady k.ISP=1E+00 2.Rdata")
...
sim.info$index <- 2
sim.info$code <- "12 CSFe Steady k.ISP=1E-01"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 (start from 20 CSFe Dynamic k.iSP=1E-02)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "12 CSFe Transient k.ISP=1E-02"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (start from 20 CSFe Transient k.ISP=1E-01 1)
#=============================================================================
...
load("12 CSFe Steady k.ISP=1E-02 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "12 CSFe Transient k.ISP=1E-03"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (start from 20 CSFe Transient k.ISP=1E-03 1)
#=============================================================================

load("20 CSFe Transient k.ISP=1E-03 1.Rdata")
...
#=============================================================================
# Dynamic simulation 1 (start from 20 CSFe Dynamic k.iSP=1E-03)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Transient k.ISP=1E-04"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (start from 20 CSFe Transient k.ISP=1E-04 1)
#=============================================================================

load("20 CSFe Transient k.ISP=1E-04 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "20 CSFe Steady k.ISP=1E-04"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 (start from 20 CSFe Dynamic k.iSP=1E-04)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Transient k.ISP=1E-05"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (start from 20 CSFe Transient k.ISP=1E-05 1)
#=============================================================================

load("20 CSFe Transient k.ISP=1E-05 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "20 CSFe Steady k.ISP=1E-05"
sim.info$name <- paste(sim.info$code,sim.info$index)
