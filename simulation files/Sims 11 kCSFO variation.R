...
sim.info$index <- 1
sim.info$code <- "20 CSFe Transient k.CSFO=494"
...
load("20 CSFe Transient k.CSFO=494 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "20 CSFe Steady k.CSFO=494"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "11 CSFe Transient k.CSFO=34"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Transient k.CSFO=34 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=34"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=34 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=24"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=24 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=14"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=14 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=04"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=04 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=00"
sim.info$name <- paste(sim.info$code,sim.info$index)
