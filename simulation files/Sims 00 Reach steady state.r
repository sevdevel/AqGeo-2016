...
load("00 CSFe Transient 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "00 CSFe Transient"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("00 CSFe Transient 2.Rdata")
...
#=============================================================================
# Dynamic simulation 4 (start from previous initial conditions)
#=============================================================================

load("00 CSFe Transient 3.Rdata")
