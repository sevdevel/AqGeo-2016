...
sim.info$index <- 1
sim.info$code <- "11 CSFe Transient k.CSFO=494e+01"
...
load("11 CSFe Transient k.CSFO=494e+01 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=494e+01"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=494e+01 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "11 CSFe Transient k.CSFO=494e+02"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Transient k.CSFO=494e+02 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=494e+02"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=494e+02 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "11 CSFe Transient k.CSFO=494e+03"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Transient k.CSFO=494e+03 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=494e+03"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Steady k.CSFO=494e+03 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "11 CSFe Transient k.CSFO=494e+04"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Transient k.CSFO=494e+04 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=494e+04"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "11 CSFe Transient k.CSFO=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("11 CSFe Transient k.CSFO=0 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "11 CSFe Steady k.CSFO=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
