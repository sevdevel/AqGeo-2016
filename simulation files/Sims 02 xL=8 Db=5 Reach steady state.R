...
sim.info$index <- 1
sim.info$code <- "CSFe Transient Db=5 x.L=8"
...
sim.info$time.seq <- c(0,1,6,12,24,48,24*10,100*24*365.25)/(24*365.25) 
...
#=============================================================================
# Dynamic simulation 2 (start from previous initial conditions)
#=============================================================================

load("CSFe Transient Db=5 x.L=8 1.Rdata")
...
load("CSFe Transient Db=5 x.L=8 2.Rdata")
...
sim.info$time.seq <- c(0,1,6,12,24,48,24*10,3000*24*365.25)/(24*365.25) 
...
#=============================================================================
# Dynamic simulation 4 (start from x.L=6)
#=============================================================================

load("02 CSFe Transient Db=5 x.L=10 3.Rdata")
