...
#=============================================================================
# Dynamic simulation 2 (Db=4)
#=============================================================================

load("01 CSFe Steady Db=0.1 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "01 CSFe Transient Db=0.01 x.L=5"
...
sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=4 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Steady Db=4 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=2 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Steady Db=2 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=1 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Steady Db=1 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=0.5 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Steady Db=0.5 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=0.25 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Steady Db=0.25 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=0.1 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=0.01 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "01 CSFe Transient Db=0 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Transient Db=0 x.L=5 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=0 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Transient Db=6 x.L=5 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Transient Db=6 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Transient Db=6 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 3
sim.info$code <- "01 CSFe Steady Db=6 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "01 CSFe Transient Db=8 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Transient Db=8 x.L=5 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "01 CSFe Steady Db=8 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "01 CSFe Transient Db=10 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("01 CSFe Transient Db=10 x.L=5 1.Rdata")
...
#=============================================================================
# Steady simulation 2 (Db=10)
#=============================================================================

load("01 CSFe Transient Db=10 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 3
sim.info$code <- "01 CSFe Steady Db=10 x.L=5"
sim.info$name <- paste(sim.info$code,sim.info$index)
