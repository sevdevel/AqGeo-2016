...
#=============================================================================
# Dynamic simulation O2b=0 F.FeOOH=0
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "20 CSFe Transient O2.ow=0 F.FeOOH=0"
...
sim.info$time.seq <- c(24*7,24*14,24*21,24*28,24*35,24*42,24*49,24*56)/(24*365.25) 
sim.info$time.schedule <- c("1 w","2 w","3 w","4 w","5 w","6 w","7 w","8 w")
