...
sim.info$index <- 1
sim.info$code <- "CSFe Transient Db=5 x.L=6"
...
load("CSFe Transient Db=5 x.L=6 1.Rdata")
...
load("02 CSFe Transient Db=5 x.L=6 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 3
sim.info$code <- "02 CSFe Transient Db=5 x.L=6"
sim.info$name <- paste(sim.info$code,sim.info$index)
