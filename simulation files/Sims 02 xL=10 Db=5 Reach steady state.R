...
sim.info$index <- 1
sim.info$code <- "CSFe Transient Db=5 x.L=10"
...
load("CSFe Transient Db=5 x.L=10 1.Rdata")
...
load("CSFe Transient Db=5 x.L=10 2.Rdata")
...
#=============================================================================
# Dynamic simulation 4 (start from x.L=8)
#=============================================================================

load("CSFe Transient Db=5 x.L=8 4.Rdata")
