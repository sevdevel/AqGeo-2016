...
#=============================================================================
# Steady simulation 2 (Db=0.15)
#=============================================================================

load("04 CSFe Steady Db~xL=0.075 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.1 KFIS=696"
...
#=============================================================================
# Steady simulation 2 (Db=0.075)
#=============================================================================

load("04 CSFe Steady Db~xL=0.05 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.075 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (Db=0.05)
#=============================================================================

load("04 CSFe Steady Db~xL=0.02 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.05 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (Db=0.02)
#=============================================================================

load("04 CSFe Steady Db~xL=0.01 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.02 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "04 CSFe Transient Db~xL=0.01 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (Db=0.01)
#=============================================================================

load("04 CSFe Transient Db~xL=0.01 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.01 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 2
sim.info$code <- "04 CSFe Transient Db~xL=0 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Transient Db~xL=0 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "04 CSFe Transient Db~xL=2 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Transient Db~xL=2 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=2 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Steady Db~xL=2 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=1 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Steady Db~xL=0.5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "04 CSFe Transient Db~xL=0.5 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Transient Db~xL=0.5 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.5 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Transient Db~xL=0.25 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Transient Db~xL=0.25 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Transient Db~xL=0.25 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=0.25 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "04 CSFe Transient Db~xL=0.1 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$time.seq <- c(0,1,6,12,24,48,24*10,2*24*365.25)/(24*365.25) 
sim.info$time.schedule <- c("0 hr","1 hr","6 hr","12 hr","1 d","2 d","10 d","200 yr")
sim.info$N.out <- length(sim.info$time.seq)
...
load("04 CSFe Transient Db~xL=0.1 KFIS=696 1.Rdata")
...
sim.info$index <- 1
sim.info$code <- "04 CSFe Transient Db~xL=6 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("04 CSFe Transient Db~xL=6 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "04 CSFe Steady Db~xL=6 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
