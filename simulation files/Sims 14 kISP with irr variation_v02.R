...
load("05 CSFe Steady alpha=0.5 Db=4 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+03 + irr KFIS=696"
...
load("14 CSFe Steady k.ISP=1E+03 + irr KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Transient k.ISP=1E+02 + irr KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Transient k.ISP=1E+02 + irr KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+02 + irr KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Steady k.ISP=1E+02 + irr KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Transient k.ISP=1E+01 + irr KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Transient k.ISP=1E+01 + irr KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+01 + irr KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Steady k.ISP=1E+01 + irr KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Transient k.ISP=1E+00 + irr KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Transient k.ISP=1E+00 + irr KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "14 CSFe Steady k.ISP=1E+00 + irr KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("14 CSFe Steady k.ISP=1E+00 + irr KFIS=696 1.Rdata")
