...
sim.info$index <- 1
sim.info$code <- "06 CSFe Transient KFIS=0 Db=4"
...
#=============================================================================
# Steady simulation 2 KFIS=0
#=============================================================================

load("06 CSFe Transient KFIS=0 Db=4.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "06 CSFe Steady KFIS=0 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("06 CSFe Steady KFIS=0 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "06 CSFe Steady KFIS=10 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 KFIS=100
#=============================================================================

load("06 CSFe Steady KFIS=10 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "06 CSFe Transient KFIS=100 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 K.FIS=100
#=============================================================================

load("06 CSFe Transient KFIS=100 Db=4 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "06 CSFe Steady KFIS=100 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("06 CSFe Steady KFIS=100 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "06 CSFe Transient KFIS=696.8 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 KFIS=696.8
#=============================================================================

load("06 CSFe Transient KFIS=696.8 Db=4 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "06 CSFe Steady KFIS=696.8 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
