...
source("CH2O CO2 O2 SO4 H2S FeS FeOH3 SVDV_v02.R")
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=1 Db=4 KFIS=696"
...
load("05 CSFe Transient alpha=1 Db=4 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=1 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("06 CSFe Steady KFIS=696.8 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.05 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Transient alpha=0.05 Db=4 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.05 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Steady alpha=0.05 Db=4 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.1 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Steady alpha=0.1 Db=4 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.175 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 irr = 0.3, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.175 Db=4 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.3 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Transient alpha=0.3 Db=4 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.3 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.4 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Transient alpha=0.4 Db=4 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.4 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.5 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 irr = 0.2, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.25 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.2 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Transient alpha=0.2 Db=4 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.2 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Steady alpha=0.6 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.6 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Steady alpha=0.75 Db=4 2 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.7 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.7, Db~xL=5
#=============================================================================

load("05 CSFe Transient alpha=0.7 Db=4 KFIS=696 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.7 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.8, Db~xL=4
#=============================================================================

load("05 CSFe Steady alpha=0.9 Db=4 KFIS=696 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.8 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Steady alpha=0.9 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.9 Db=4 KFIS=696"
sim.info$name <- paste(sim.info$code,sim.info$index)
