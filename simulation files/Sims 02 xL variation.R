...
#=============================================================================
# Transient simulation 2 (x.L=0.1)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "02 CSFe Transient Db=5 x.L=0.1"
...
sim.info$time.schedule <- c("0 hr","1 hr","6 hr","12 hr","1 d","2 d","10 d","100 yr")
...
#=============================================================================
# Steady simulation 2 (x.L=0.1)
#=============================================================================

load("02 CSFe Transient Db=5 x.L=0.1 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=0.1"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Transient simulation 2 (x.L=0.25)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "02 CSFe Transient Db=5 x.L=0.25"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (x.L=0.25)
#=============================================================================

load("02 CSFe Transient Db=5 x.L=0.25 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=0.25"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
save(sim.info, plot.info, simulation.list, file = paste(sim.info$name,".Rdata",sep="")) 
#=============================================================================
# Transient simulation 2 (x.L=0.5)
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "02 CSFe Transient Db=5 x.L=0.5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (x.L=0.5)
#=============================================================================

load("02 CSFe Transient Db=5 x.L=0.5 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=0.5"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (x.L=1)
#=============================================================================

load("02 CSFe Steady Db=5 x.L=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=1"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=2"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (x.L=6)
#=============================================================================

load("00 CSFe Steady 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=6"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Transient simulation 2 (x.L=8)
#=============================================================================

load("02 CSFe Steady Db=5 x.L=6 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "02 CSFe Transient Db=5 x.L=8"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (x.L=8)
#=============================================================================

load("02 CSFe Transient Db=5 x.L=8 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=8"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Transient simulation 2 (x.L=10)
#=============================================================================

load("02 CSFe Steady Db=5 x.L=8 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "02 CSFe Transient Db=5 x.L=10"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (x.L=10)
#=============================================================================

load("02 CSFe Transient Db=5 x.L=10 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 x.L=10"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("02 CSFe Steady Db=5 x.L=10 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "02 CSFe Transient Db=5 cte"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 (Db=cte)
#=============================================================================

load("02 CSFe Transient Db=5 cte 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "02 CSFe Steady Db=5 cte"
sim.info$name <- paste(sim.info$code,sim.info$index)
