...
sim.info$index <- 1
sim.info$code <- "CSFe Transient Db=0 x.L=5"
...
load("CSFe Transient Db=0 x.L=5 1.Rdata")
...
load("CSFe Transient Db=0 x.L=5 2.Rdata")
...
load("CSFe Transient Db=0 x.L=5 3.Rdata")
