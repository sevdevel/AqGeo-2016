...
load("04 CSFe Steady Db~xL=4 2.Rdata")
...
load("05 CSFe Transient alpha=0.25 Db=4 2.Rdata")
...
#=============================================================================
# Dynamic simulation 1 irr = 0.5, Db~xL=5
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.5 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
load("05 CSFe Transient alpha=0.5 Db=4 1.Rdata")
