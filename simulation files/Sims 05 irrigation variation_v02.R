...
#=============================================================================
# Dynamic simulation 1 irr = 1, no bioturbation
#=============================================================================

load("01 CSFe Steady Db=0 x.L=5 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=1 Db=0"
...
#=============================================================================
# Steady simulation 2 irr = 1, no bioturbation
#=============================================================================

load("05 CSFe Transient alpha=1 Db=0 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=1 Db=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 irr = 0.1, no bioturbation
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.1 Db=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.1, no bioturbation
#=============================================================================

load("05 CSFe Transient alpha=0.1 Db=0 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.1 Db=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 irr = 0.5, no bioturbation
#=============================================================================

load("05 CSFe Steady alpha=0.1 Db=0 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.5 Db=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.5, no bioturbation
#=============================================================================

load("05 CSFe Transient alpha=0.5 Db=0 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.5 Db=0"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 irr = 1, Db~xL=5
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=1 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 1, Db~xL=5
#=============================================================================

load("05 CSFe Transient alpha=1 Db=4 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=1 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=0.05 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.05, Db~xL=5
#=============================================================================

load("05 CSFe Transient alpha=0.05 Db=4 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.05 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.1, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.05 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.1 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.175, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.1 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.175 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.3, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.175 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.3 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.4, Db~xL=5
#=============================================================================

load("05 CSFe Transient alpha=0.3 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.4 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.5, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.4 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.5 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.51, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.5 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.51 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.52, Db~xL=5
#=============================================================================
...
sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.52 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.515, Db~xL=5
#=============================================================================
...
sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.515 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.525, Db~xL=5
#=============================================================================
...
sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.525 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.55, Db~xL=5
#=============================================================================
...
sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.55 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.25, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=0.3 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.25 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.6, Db~xL=5
#=============================================================================
...
sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.6 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.75, Db~xL=5
#=============================================================================

load("05 CSFe Steady alpha=1 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.75 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 0.9, Db~xL=4
#=============================================================================

load("05 CSFe Steady alpha=0.75 Db=4 2.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=0.9 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Dynamic simulation 1 irr = 2, Db~xL=5
#=============================================================================
...
sim.info$index <- 1
sim.info$code <- "05 CSFe Transient alpha=2 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
...
#=============================================================================
# Steady simulation 2 irr = 2, Db~xL=5
#=============================================================================

load("05 CSFe Transient alpha=2 Db=4 1.Rdata")

# Initialisation simulation type 

sim.info$index <- 2
sim.info$code <- "05 CSFe Steady alpha=2 Db=4"
sim.info$name <- paste(sim.info$code,sim.info$index)
